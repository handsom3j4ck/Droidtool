...
- TV Debloat: Disable unnecessary apps on Android TV devices, including TV sticks and boxes.
- TV Launcher Settings: Disable various launchers (don’t forget to install and set up a custom launcher first)
