...
- Comprehensive device report including brand, model, Android version, SDK, serial, build ID, security patch, kernel, mac, rooted status, uptime, battery (level, status, health, temp), storage usage, memory info, arch, screen resolution, network (currently only works with wifi), hardware (CPU, GPU)
...
- Apply general-purpose performance improvements (This could damage your device. Use at your own risk)
- Processing speed boost (This could damage your device. Use at your own risk)
- Optimize application performance (This could damage your device. Use at your own risk)
- Remove ads via private DNS (AdGuard, ControlD, Quad9, NextDNS, Cloudflare)
